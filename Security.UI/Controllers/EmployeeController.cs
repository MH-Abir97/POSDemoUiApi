...
namespace Security.UI.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public JsonResult GetEmployeeEmailByDocumentRef(int refEmployeeId, string invoiceType)
        {
            try
            {
                var designationList = Facade.Employee.GetEmployeeEmailByDocumentRef(refEmployeeId, invoiceType);
                return Json(designationList, JsonRequestBehavior.AllowGet);
            }
            catch (Exception ex)
            {
