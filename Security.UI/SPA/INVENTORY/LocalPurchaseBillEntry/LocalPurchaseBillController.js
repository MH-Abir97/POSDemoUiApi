            ...
            if (e) {
               ...
               // });
                ...
                if ($scope.inv_PurchaseBillLocal.AdditionDiscount != undefined && $scope.inv_PurchaseBillLocal.AdditionDiscount != null) {
                    ...
                    $scope.inv_PurchaseBillLocal.TotalAmountAfterDiscount = $scope.TotaInclusiveprice - additionalAfterDiscount;
                    $scope.inv_PurchaseBillLocal.AdditionDiscount;

                    $scope.inv_PurchaseBillLocal.TotalAmount = $scope.TotaInclusiveprice;

                } else {
                    $scope.inv_PurchaseBillLocal.TotalAmountAfterDiscount = $scope.TotaInclusiveprice;
                    $scope.inv_PurchaseBillLocal.TotalAmount = $scope.TotaInclusiveprice;
                    $scope.inv_PurchaseBillLocal.AdditionDiscount;
                }
                ...
                $.ajax({
                    ...
                    contentType: "application/json;charset=utf-8",
                    type: "POST",
                    data: JSON.stringify({ Local_inv_PurchaseBill: $scope.inv_PurchaseBillLocal, Local_inv_PurchaseBillDetailLst: pbItemList, inv_LocalPurchaseBillDetailSerial: warrentyAndSerialList }),
                    success: function (data) {
                        if (data > 0) {
