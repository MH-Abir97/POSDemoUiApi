app.controller("TruckChallanReportController", function ($scope, $cookieStore, $http, $filter, $window) {
    $scope.LoginUser = $cookieStore.get('UserData');
    $scope.CommercialInvoiceId = $cookieStore.get('CommercialInvoiceId');
    Clear();

    function Clear() {
        $scope.TruckChallanInfoList = [];
        GetCIMasterByCIid();
    ...
    $scope.test = function () {
        ...
        //$("#ciTable tbody tr:nth-child(1)").attr("counter-reset", "rowNumber");
        //$("#ciTable tbody tr").attr("counter-increment", "rowNumber");
        //$("#ciTable tbody tr td:nth-child(1)").attr("content", "counter(rowNumber)");

        //$("#ciTable tbody tr td:nth-child(1)").css("background-color", "red");
        //$("#ciTable tbody tr").css("counter-increment", "rowNumber");
        //$("#ciTable tbody tr td:first-child::before").css("content", "counter(rowNumber)");
    ...
    function GetCIMasterByCIid() {
        $http({
            ...
            $scope.CommercialInvoiceMasterList[0].CommercialInvoiceNo = $scope.CommercialInvoiceMasterList[0].CommercialInvoiceNo.replace("CI", "TC");
        });
    }
    ...
    function GetAllTruckChallan() {
        $http({
            ...
            $scope.TruckChallanInfoList = $scope.TruckChallanList.filter(tc => tc.CommercialInvoiceId === $scope.CommercialInvoiceId);
        });
