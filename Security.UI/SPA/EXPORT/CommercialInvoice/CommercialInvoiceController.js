...
app.controller("CommercialInvoiceController", function ($scope, hotkeys, $cookieStore, $http, $filter, $window) {
    ...
    function Clear() {
        ...
        $scope.PerPage = 10;
        $scope.total_count = 0;
        GetCommercialInvoicePaged($scope.currentPage);
    }
    Clear();
    ...
    function newFun() {
        ...
        for (var p = 0; p < pb[0].length; p++) {
            ...
            for (var k = 0; k < pb.length - 1; k++) {
                ...
                //if ($scope.CustomiseTableData.ColName == "Qty" || $scope.CustomiseTableData.ColName == "Unit Price" || $scope.CustomiseTableData.ColName == "Amount") {
                //    var IsNaN = parseFloat($scope.CustomiseTableData.ColValue);
                //    if (isNaN(IsNaN)) {
                //        alert("Invalid!!");
                //        return;
                //    }
    ...
    function GetExpoterInfo(GetExpoterId) {
        ...
        if (GetExpoterId == 1) {
            ...
            $(".summernoteExporterInfo").summernote("code", $scope.ExporterInfo);
        ...
        //angular.forEach($scope.ExporterList, function (data) {

        //    $scope.ExporterInfo = "<b>" + data.ExporterName + "</b><br>" +

        //        "<b>Factory Address: </b>" + data.ExporterAddress + "<br>" +
        //        "<b>TIN: </b>" + data.TIN + "<b> BIN: </b>" + data.BIN + "<br>" +
        //        "<b>E-Mail- </b>" + data.Email + (($scope.ddlImporter.RefEmail == "") ? "" : " & " + $scope.ddlImporter.RefEmail) + "<br>" +
        //        "<b>Web- </b>" + data.Website + "<b> Tel: </b>" + data.TelephoneNo + "<br>" +
        //        "<b>Cell: </b>" + data.MobileNo + (($scope.ddlImporter.RefContactNo == "") ? "" : " & " + $scope.ddlImporter.RefContactNo) + "<br>"
        //    $(".summernoteExporterInfo").summernote("code", $scope.ExporterInfo);
    ...
    function GetbranchId(branchId) {
        ...
        //console.log($scope.ExporterBankList);
        //if (branchId == 1) {
        //    $scope.ExporterBankInfo = "<b>Bank Name: </b>" + $scope.ExporterBankList[0].BankName + "<br>" +
        //        "<b>Account Name: </b>" + $scope.ExporterBankList[0].AccountName + "<br>" +
        //        "<b>Account No: </b>" + $scope.ExporterBankList[0].AccountNo + "<br>" +
        //        "<b>Swift Code: </b>" + $scope.ExporterBankList[0].SwiftCode + "<br>" +
        //        "<b>Branch Address: </b>" + $scope.ExporterBankList[0].BranchAddress
        //    console.log($scope.ExporterBankList);
        //} else if (branchId == 2) {
        //    $scope.ExporterBankInfo = "<b>Bank Name: </b>" + $scope.ExporterBankList[2].BankName + "<br>" +
        //        "<b>Account Name: </b>" + $scope.ExporterBankList[2].AccountName + "<br>" +
        //        "<b>Account No: </b>" + $scope.ExporterBankList[2].AccountNo + "<br>" +
        //        "<b>Swift Code: </b>" + $scope.ExporterBankList[2].SwiftCode + "<br>" +
        //        "<b>Branch Address: </b>" + $scope.ExporterBankList[2].BranchAddress
        //    console.log($scope.ExporterBankList);
        //} else  {
        //    $scope.ExporterBankInfo = "<b>Bank Name: </b>" + $scope.ExporterBankList[1].BankName + "<br>" +
        //        "<b>Account Name: </b>" + $scope.ExporterBankList[1].AccountName + "<br>" +
        //        "<b>Account No: </b>" + $scope.ExporterBankList[1].AccountNo + "<br>" +
        //        "<b>Swift Code: </b>" + $scope.ExporterBankList[1].SwiftCode + "<br>" +
        //        "<b>Branch Address: </b>" + $scope.ExporterBankList[1].BranchAddress
        //    console.log($scope.ExporterBankList);

        //}
        $(".summernoteExporterBankInfo").summernote("code", $scope.ExporterBankInfo);

        //var exporterBankInfo = $(".summernoteExporterBankInfo").summernote("code");
    ...
    $scope.AddImpoterBank = function () {
        $('#importerBankModal').modal('show');
        //var ImporterBankDetails = Enumerable.From($scope.ImporterBankList)
        //    .Where("$.BankAccountId === " + $scope.ddlImporterBank.BankAccountId).FirstOrDefault();
        //$scope.ad_BankAccount = ImporterBankDetails;
        //$scope.ddlAccountFor = { "AccountFor": $scope.ad_BankAccount.AccountFor };
        //GetAccountFor($scope.ad_BankAccount.AccountFor);
        //$scope.ddlAccountRef = { "CompanyId": $scope.ad_BankAccount.AccountRefId };
    }

    $scope.SaveAmendmentRequest = function () {
        $scope.exp_AmendmentRequest.ApprovalType = "CIAmendment";
    ...
    $scope.GetAmendment = function (aCommercialInvoice) {

        $scope.PaymentProcessForAmendment = {
            LcScNo: aCommercialInvoice.LcScNo,
            ImporterName: aCommercialInvoice.CompanyName
        }
    }
    ...
    //    var type;
    //    var errorMsg = [];
    //    $scope.exportInvoice.IsAmendment = false;
    //    $scope.exportInvoice.IsSubmit = true;
        
    //    if (!errorMsg.length) {
    //        alertify.confirm("Are you want to submit? You will not modify this PI before amendment request", function (e) {
    //            if (e) {
    //                var sOIds = '';
    //                angular.forEach($scope.SalesOrderList, function (e) {
    //                    if (e.IsCheck) {
    //                        sOIds += sOIds === '' ? ('' + e.SalesOrderId) : (',' + e.SalesOrderId);
    //                        $scope.SOCount++;
    //                    }
    //                });
    //                if ($scope.SOCount < 1) {
    ...
    //                    return;
    //                }
    //                $scope.exportInvoice.SalesOrderIds = sOIds;
    //                var params = JSON.stringify({ exp_Invoice: $scope.exportInvoice, pos_SalesOrderDetailList: $scope.SalesOrderItemCopyList, exp_PackingInfo: $scope.PackingListObj });

    //                $http.post('/ExpInvoice/Post', params).success(function (data) {
    //                    if (data !== "") {
    //                        alertify.log(data, 'success', '5000');
    //                        Clear();
    //                        $scope.SalesOrderItemCopyList = [];
    //                        $('#idCopySelected').prop("checked", false);
    ...
    $scope.SelCommercialInvoice = function (aCommercialInvoice) {
        if (aCommercialInvoice.DocStatus !== 'Draft') {
            alertify.log('This CI can not be modified', 'error', '2000');
            return;
        }
        ...
        GetCommercialInvoiceInfoByCiId(aCommercialInvoice.CommercialInvoiceId);
        $scope.ddlImporter = { "CompanyId": aCommercialInvoice.CompanyId };
        $scope.ddlExporter = { "ExporterId": aCommercialInvoice.ExporterId };
        $scope.ddlExporterBank = { "BankAccountId": aCommercialInvoice.ExporterBankAccountId };
        $scope.ItemTableDataRow = [];
        $scope.DataRow = [];
        LoadInvoice($scope.ddlImporter, aCommercialInvoice.CommercialInvoiceId);
        GetCommercialInvoiceDetailByCommercialInvoiceId(aCommercialInvoice.CommercialInvoiceId);

        $http({
            url: '/ExpCommercialInvoice/GetPOReference?DocType=CI' + "&DocumentId=" + aCommercialInvoice.CommercialInvoiceId,
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        }).success(function (data) {
            if (data.length) {
        ...
        ////////////////////////////
        //var invoiceIdArr = [];
        //invoiceIdArr = aCommercialInvoice.InvoiceIds.split(',');
        //for (var i = 0; i < invoiceIdArr.length; i++) {
        //    var invoiceId = Number(invoiceIdArr[i]);
        //    $http({
        ...
        //}
            ...
            $http({
                url: "/ExpCommercialInvoice/GetCommercialInvoiceDetailByCommercialInvoiceId?CiId=" + aCommercialInvoice.CommercialInvoiceId,
                method: "GET",
                headers: { 'Content-Type': "application/json" }
            }).success(function (Productdata) {
        ...
        $http({
            url: "/ExpCommercialInvoice/GetPackingInfo?commercialInvoiceId=" + aCommercialInvoice.CommercialInvoiceId,
            method: "GET",
            headers: { 'Content-Type': "application/json" }
        ...
        var isLcScDate = isNaN(aCommercialInvoice.LcScDate);
        var isMasterDate = isNaN(aCommercialInvoice.MasterContactDate);
        //var isPiRefDate = isNaN(aCommercialInvoice.PiRefDate);

        if (isLcScDate == true) {
            var res1 = aCommercialInvoice.LcScDate.substring(0, 5);
            if (res1 == "/Date") {
                var parsedDate1 = new Date(parseInt(aCommercialInvoice.LcScDate.substr(6)));
                var date1 = ($filter('date')(parsedDate1, 'MMM dd, yyyy')).toString();
                aCommercialInvoice.LcScDate = date1;
            }
        }

        if (isMasterDate == true) {
            var res2 = aCommercialInvoice.MasterContactDate.substring(0, 5);
            if (res2 == "/Date") {
                var parsedDate2 = new Date(parseInt(aCommercialInvoice.MasterContactDate.substr(6)));
                var date2 = ($filter('date')(parsedDate2, 'MMM dd, yyyy')).toString();
                aCommercialInvoice.MasterContactDate = date2;
            }
        }
        //if (isPiRefDate == true) { 
        //    var res5 = aCommercialInvoice.PiRefDate.substring(0, 5);
        //    if (res5 == "/Date") {
        //        var parsedDate5 = new Date(parseInt(aCommercialInvoice.PiRefDate.substr(6)));
        //        var date5 = ($filter('date')(parsedDate5, 'MMM dd, yyyy')).toString();
        //        aCommercialInvoice.PiRefDate = date5;
        //    }
        //}
        ...
        //    }
        //}
        $scope.ddlPaymentProcessType = { PaymentProcessType: aCommercialInvoice.PaymentProcessType };
        //GetImporterBank('Customer');
        GetImporterBankByRefId(aCommercialInvoice.CompanyId, 'Customer')
        $scope.ddlImporterBank = { BankAccountId: aCommercialInvoice.ImporterBankId };
        GetExpoterInfo();
        $(".summernoteExporterInfo").summernote("code", $scope.exp_CommercialInvoice.ExporterInfo);
        $(".summernoteExporterBankInfo").summernote("code", $scope.exp_CommercialInvoice.ExporterBankInfo);
        $scope.chkDisable = true;
        $scope.btnSwapDisable = true;
    ...
    function SearchProformaInvoice() {
        var criteria = "";
    ...
    function GetCommercialInvoiceDetailByCommercialInvoiceId(CiId) {
        ...
        $http({
            ...
            $scope.InvoiceWiseItemList = data;
            //console.log("InvoiceWiseItemList", $scope.InvoiceWiseItemList);
            ...
            //    if ($scope.ItemTableHeadersN[0][i] === "Qty") {
            //        $scope.ItemTableFooter.push($scope.QtySumForItem);
            //    }
            //    else if ($scope.ItemTableHeadersN[0][i] === "Amount") {
            //        $scope.ItemTableFooter.push($scope.AmountSumForItem);
            //    }
            //    else if ($scope.ItemTableHeadersN[0][i] === "Unit Price") {
    ...
    $scope.OpenPopupWindowForDelivery = function (ciId) {
        $window.open("#/DeliveryChallanReport", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    $scope.OpenPopupWindowForPacking = function (ciId) {
        $window.open("#/PackingReport", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    $scope.OpenPopupWindowForTruck = function (ciId) {
        $window.open("#/TruckChallanReport", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    $scope.OpenPopupWindowForBank = function (ciId) {
        $window.open("#/BankReport", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    $scope.OpenPopupWindowForBeneficiary = function (ciId) {
        $window.open("#/BeneficiaryCertificateReport", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    $scope.OpenPopupWindowForBillOfExchange = function (ciId) {
        $window.open("#/BillOfExchangeReport", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    $scope.OpenPopupWindowForBillOfExchange2 = function (ciId) {
        $window.open("#/BillOfExchangeReport2", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    $scope.OpenPopupWindowForConsumptionCertificate = function (ciId) {
        $window.open("#/ConsumptionCertificateReport", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    $scope.OpenPopupWindowForOriginCertificate = function (ciId) {
        $window.open("#/CertificateReport", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    $scope.OpenPopupWindowForPreCertificate = function (ciId) {
        $window.open("#/CertificatePreReport", "popup", "width=800,height=550,left=280,top=80");
        $cookieStore.put("CommercialInvoiceId", ciId);
        event.stopPropagation();
    };
    ...
    function GetAccountFor(AccountFor) {
    ...
    function SaveCommercialInvoice(status) {
        ...
        angular.forEach($scope.ItemTableDataRow, function (anItem) {
            ...
            //var ItemName = anItem[4];
            //$scope.HSListCheck.push(ItemName);
        }); 
        //HSCode ..................................................
        //$scope.HS = [];
        //$scope.finalCheck = [];
        //$scope.HSCodeListCheck = [];
        //for (var i = 0; i < $scope.HSListCheck.length; i++) {
        //    $scope.HS = $scope.HSListCheck[i].split(': ');
        //    $scope.HSCodeListCheck.push($scope.HS[1]);
        //}

        //$scope.finalCheck = $scope.HSCodeListCheck
        //    .filter(function (item, pos) {
        //        return $scope.HSCodeListCheck.indexOf(item) == pos;
        //    })
        //$scope.exp_CommercialInvoice.HsCode = $scope.finalCheck;
        //HSCode ..................................................
        ...
        var exporterInfo = $(".summernoteExporterInfo").summernote("code");
        ...
        $http.post('/ExpCommercialInvoice/Save', parms).success(function (data) {
            if (data > 0) {
                ...
                $scope.QuantitySum = 0;
                $scope.AmountSum = 0;
                $scope.commercialInvoiceEntryForm.$setPristine();
                $scope.commercialInvoiceEntryForm.$setUntouched();
    ...
    $scope.lockAndSubmit = function () {
        //if ($scope.exp_CommercialInvoice.LcScNo == "" || $scope.exp_CommercialInvoice.LcScNo == null || $scope.exp_CommercialInvoice.LcScNo == undefined) {
        //    alertify.log('LcSc No Is Required!', 'error', '5000');
        //    return;
        //}
        //if ($scope.exp_CommercialInvoice.LcScDate == "" || $scope.exp_CommercialInvoice.LcScDate == null || $scope.exp_CommercialInvoice.LcScDate == undefined) {
        //    alertify.log('LcSc Date Is Required!', 'error', '5000');
        //    return;
        //}
        ckeckValidData();
        $scope.exp_CommercialInvoice.IsSubmitted = true;
        alertify.confirm("Are you sure to lock and submit?", function (e) {
            if (e) {
    ...
    $scope.changeImpoterReset = function () {
        changeImpoterReset();
    }

    function restMergeInvoiceDetails() {
        //$http({
        //    url: '/ExpCommercialInvoice/CommercialInvoiceDetailDeleteByCommercialInvoiceId?commercialInvoiceId=' + $scope.exp_CommercialInvoice.CommercialInvoiceId,
        //    method: 'GET',
        //    headers: { 'Content-Type': 'application/json' }
        //}).success(function (data) {
        $scope.ItemCategory = [];
    ...
    $scope.restMergeInvoiceDetails = function () {
       // alertify.confirm("Are you sure to reset all data?", function (e) {
    ...
    //$scope.Shuvo = function () {
    //    $('#ciTable  tr td:last-child()').each(function () {

    //        $(this).toggle();

    //    });

    //    $('#ciTable  tr th:last-child()').each(function () {
    ...
    Array.prototype.arrayRemove = function (array1,array2) {
        var index;
        ...
        if (value == true) {
            ...
            $http({
                ...
                if (PIheaderCountCheck($scope.baseHeaderCount, $scope.ItemTableHeaders1.length)) {
                    ...
                    //    $scope.HS = $scope.DataRow[i][4].split(': ');
                    //    $scope.HSListUncheck.push($scope.HS[1]);
                    //}
                    //$scope.finalCheck = $scope.HSListUncheck.arrayRemove($scope.HSListCheck, $scope.HSListUncheck);
                    //$scope.finalCheck = $scope.finalCheck
                    //    .filter(function (item, pos) {
                    //        return $scope.finalCheck.indexOf(item) == pos;
                    //    })
                    //$scope.exp_CommercialInvoice.HsCode = $scope.finalCheck;
                    //HSCode ..................................................
    ...
    //        var criteria = "CAST(CommercialInvoiceDate AS date) where CommercialInvoiceId  BETWEEN '" + fromDate + "' AND '" + toDate + "'";
    //    } else {
    //        companyId = null;
    //    }
    ...
    //#region
    $("#txtFromCiDate").datepicker({
        dateFormat: "M d, yy"
    });

    $scope.CalendarCiFromDate = function () {
        $("#txtFromCiDate").focus();
        $("#txtFromCiDate").trigger("click");
    }

    $("#txtToCiDate").datepicker({
        dateFormat: "M d, yy"
    });

    $scope.CalendarCiToDate = function () {
        $("#txtToCiDate").focus();
        $("#txtToCiDate").trigger("click");
    }
    //LC/SC date
    $("#txtLcScDate").datepicker({
        dateFormat: "M d, yy"
    });

    $scope.CalendarLCSC = function () {
        $("#txtLcScDate").focus();
        $("#txtLcScDate").trigger("click");
    }
    //EXp data
    ...
    $scope.CalendarExp = function () {
        $("#txtExpDate").focus();
        $("#txtExpDate").trigger("click");
    }
    //$scope.CalendarPIRef = function () {
    //    $("#txtPIRefDate").focus();
    //    $("#txtPIRefDate").trigger("click");
    //}
    //CI
    ...
    //$scope.FormChangeDate = function () {
    //    $scope.ToDate = $scope.FromDate;
    //}

    $scope.reloadBtn = function () {
        $('#txtFromDateForCI').val('');
        $('#txtToDateForCI').val('');
        $('#textInvoiceNoAndCompany').val('');
        $scope.FromDate = "";
        $scope.ToDate = "";
        $scope.SearchInvoiceAndCompanyName = null;
        GetCommercialInvoicePaged(1);
    }
    ...
    function GetCommercialInvoicePaged(curPage) {

        if (curPage == null) curPage = 1;
        var startRecordNo = ($scope.PerPage * (curPage - 1)) + 1;

        var formDateChange = $("#txtFromDateForCI").val();
        $scope.FromDate = formDateChange.split('/').reverse().join('-');

        var toDateChange = $("#txtToDateForCI").val();
        ...
        if ($scope.SearchInvoiceAndCompanyName != undefined && $scope.SearchInvoiceAndCompanyName != "" && $scope.FromDate != "" && $scope.ToDate != "") {
            SearchCriteria = "([CommercialInvoiceDate] between '" + $scope.FromDate + "' and '" + $scope.ToDate + "') and ([CommercialInvoiceNo] LIKE '%" + $scope.SearchInvoiceAndCompanyName + "%' OR [CompanyNameBilling] LIKE '%" + $scope.SearchInvoiceAndCompanyName + "%')";
            ...
            SearchCriteria = "[CommercialInvoiceNo] LIKE '%" + $scope.SearchInvoiceAndCompanyName + "%' OR [CompanyNameBilling] LIKE '%" + $scope.SearchInvoiceAndCompanyName + "%'";
            //alert("Name Success!!!!!");
        }
        else if ($scope.FromDate != "" && $scope.ToDate != "") {
            SearchCriteria = "[CommercialInvoiceDate] between '" + $scope.FromDate + "' and '" + $scope.ToDate + "'";
            //alert("Date Success!!!!!");
        }
        ...
        $http({
            url: encodeURI('/ExpCommercialInvoice/GetCommercialInvoicePaged?startRecordNo=' + startRecordNo + '&rowPerPage=' + $scope.PerPage + "&whereClause=" + SearchCriteria + '&rows=' + 0),
            method: 'GET',
            headers: { 'Content-Type': 'application/json' }
        }).success(function (data) {
            ...
            if (data.ListData.length > 0) {
                angular.forEach(data.ListData, function (aSd) {
                    ...
                    if (aSd.ExpDate != null) {
                        var res2 = aSd.ExpDate.substring(0, 5);
                        if (res2 == "/Date") {
                            var parsedDate2 = new Date(parseInt(aSd.ExpDate.substr(6)));
                            var date2 = ($filter('date')(parsedDate2, 'MMM dd, yyyy')).toString();
                            aSd.ExpDate = date2;
                        }
                    }
            ...
            $scope.CommercialInvoiceListPaged = data.ListData;
    ...
    $("#txtFromDateForCI").datepicker({
        dateFormat: "dd/mm/yy"
    });

    $scope.FormDateChangeForCi = function () {
        $("#txtFromDateForCI").focus();
        $("#txtFromDateForCI").trigger("click");
    }


    $("#txtToDateForCI").datepicker({
        dateFormat: "dd/mm/yy"
    });

    $scope.ToDateChangeForCI = function () {
        $("#txtToDateForCI").focus();
        $("#txtToDateForCI").trigger("click");
    }
